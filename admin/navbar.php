...
<nav class="navbar navbar-expand-sm bg-light navbar-light fixed-top">
    <div class="container-fluid">
        <dM class="navbar-brand" href="#">LEND MOKO</dM>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="fa fa-hand-holding-usd"></i> Collection</a>
                </li>
                <li class="nav-item">
                ...
                <li>
                    <a id="navlink" class="nav-link d-flex align-items-center" href="#"
                        ...
                        <span id="loginText">
                            <?php echo isset($_SESSION['admin_username']) ? $_SESSION['admin_username'] : 'Login'; ?>
                        </span>
                    </a>
                </li>
            </ul>
